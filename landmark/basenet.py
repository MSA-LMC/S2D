...
class MobileNet_GDConv(nn.Module):
    ...
    def forward(self,x):
        """`0 torch.Size([2, 32, 112, 112])
            1 torch.Size([2, 16, 112, 112])
            2 torch.Size([2, 24, 56, 56])
            3 torch.Size([2, 24, 56, 56])
            4 torch.Size([2, 32, 28, 28])
            5 torch.Size([2, 32, 28, 28])
            6 torch.Size([2, 32, 28, 28])
            7 torch.Size([2, 64, 14, 14])
            8 torch.Size([2, 64, 14, 14])
            9 torch.Size([2, 64, 14, 14])
            10 torch.Size([2, 64, 14, 14])
            11 torch.Size([2, 96, 14, 14])
            12 torch.Size([2, 96, 14, 14])
            13 torch.Size([2, 96, 14, 14])
            14 torch.Size([2, 160, 7, 7])
            15 torch.Size([2, 160, 7, 7])
            16 torch.Size([2, 160, 7, 7])
            17 torch.Size([2, 320, 7, 7])
            18 torch.Size([2, 1280, 7, 7])
        """
        for i, blk in enumerate(self.base_net[0]):
            x = blk(x)
            if i == 13:
                feat = x
        x = self.linear7(x)
